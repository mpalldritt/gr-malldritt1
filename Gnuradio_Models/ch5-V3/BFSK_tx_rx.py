...
class BFSK_tx_rx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "BFSK TX RX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BFSK TX RX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "BFSK_tx_rx")
...
def main(top_block_cls=BFSK_tx_rx, options=None):
