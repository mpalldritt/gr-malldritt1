...
class ook_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._noise_level_range = qtgui.Range(0, 10, 1, 0.0, 200)
        ...
        self._delay_range = qtgui.Range(0, 10000, 1, 0, 200)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, '/home/michael/Desktop/Gnuradio_Models-20250814T003349Z-1-001/Gnuradio_Models/ch5/BER-test-data.dat', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_divide_xx_0_0 = blocks.divide_ff(1)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, 443)
        ...
        self.connect((self.band_pass_filter_1, 0), (self.blocks_complex_to_mag_squared_0, 0))
