...
class pkt_fsk_rcv(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._sq_lvl_win = qtgui.RangeWidget(self._sq_lvl_range, self.set_sq_lvl, "Squelch", "counter", float, QtCore.Qt.Horizontal)
        ...
        for c in range(0, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(decim, firdes.low_pass(1.0,samp_rate,3000,400), center, samp_rate)
