...
# Title: pkt_fsk_xmt
# Author: Barry Duggan modified by MA
...
class pkt_fsk_xmt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default'):
        ...
        # Variables
        ##################################################
        self.space = space = 39500
        self.mark = mark = 40500
        ...
        self.connect((self.blocks_stream_to_tagged_stream_1, 0), (self.blocks_throttle2_0_0, 0))
        self.connect((self.blocks_tagged_stream_mux_0_0, 0), (self.blocks_repack_bits_bb_1_0, 0))
        self.connect((self.blocks_throttle2_0_0, 0), (self.digital_crc32_bb_0_0, 0))
