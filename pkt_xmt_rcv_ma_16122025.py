...
class pkt_xmt_rcv_ma_16122025(gr.top_block, Qt.QWidget):

    def __init__(self, InFile='default'):
        gr.top_block.__init__(self, "pkt_xmt_rcv_ma_16122025", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("pkt_xmt_rcv_ma_16122025")
        ...
        self.settings = Qt.QSettings("GNU Radio", "pkt_xmt_rcv_ma_16122025")
        ...
        self.low_pass_filter_taps = low_pass_filter_taps = firdes.low_pass(1.0, samp_rate, 1500,300, window.WIN_HAMMING, 6.76)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_low_pass_filter_taps(firdes.low_pass(1.0, self.samp_rate, 1500, 300, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=pkt_xmt_rcv_ma_16122025, options=None):
    if options is None:
