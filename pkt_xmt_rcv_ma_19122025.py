...
class pkt_xmt_rcv_ma_19122025(gr.top_block, Qt.QWidget):

    def __init__(self, InFile='default'):
        gr.top_block.__init__(self, "pkt_xmt_rcv_ma_19122025", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("pkt_xmt_rcv_ma_19122025")
        ...
        self.settings = Qt.QSettings("GNU Radio", "pkt_xmt_rcv_ma_19122025")
        ...
        for c in range(2, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.filter_fft_rrc_filter_0 = filter.fft_filter_ccc(1, firdes.root_raised_cosine(1, samp_rate, (samp_rate/sps), excess_bw, (11*samp_rate)), 1)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_agc_xx_0, 0), (self.filter_fft_rrc_filter_0, 0))
        ...
        self.connect((self.filter_fft_rrc_filter_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
    ...
    def set_sps(self, sps):
        ...
        self.filter_fft_rrc_filter_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, (self.samp_rate/self.sps), self.excess_bw, (11*self.samp_rate)))
...
def main(top_block_cls=pkt_xmt_rcv_ma_19122025, options=None):
    if options is None:
